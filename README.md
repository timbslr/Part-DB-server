# Steps after fetching this Repository:
...
_Hint:_ A docker image is available under [jbtronics/part-db1](https://hub.docker.com/r/jbtronics/part-db1). How to set
...
9. Access Part-DB in your browser (under the URL you put it) and log in with user _admin_. Password is the one outputted
   during DB setup.
...
-   **Jan Böhmer** - _Initial work_ - [GitHub](https://github.com/jbtronics/)
